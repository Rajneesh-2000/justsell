...
public class ElectronicRecycleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_electronic_recycle);
        ...
        mdatabaseref =firebaseDatabase.getReference("electronics");
