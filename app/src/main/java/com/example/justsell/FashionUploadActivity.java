...
public class FashionUploadActivity extends AppCompatActivity {
        ...
        Task<Uri> uriTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        ...
                        Uri downloadUri = task.getResult();
                            ...
                            mdatabaseref =database.getReference("fashion");
                        ...
                        Toast.makeText(FashionUploadActivity.this, "Data save Successful", Toast.LENGTH_SHORT).show();
                            dialog.dismiss();
