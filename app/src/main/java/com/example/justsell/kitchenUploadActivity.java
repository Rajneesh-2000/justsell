...
import com.squareup.picasso.Picasso;
                ...
                public class kitchenUploadActivity extends AppCompatActivity {
                    ...
                    protected void onCreate(Bundle savedInstanceState) {
                        ...
                        setContentView(R.layout.activity_kitchen_upload);
                        ...
                        Task<Uri> uriTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                                    ...
                                    public void onComplete(@NonNull Task<Uri> task) {
                                        ...
                                        Uri downloadUri = task.getResult();
                                            ...
                                            mdatabaseref =database.getReference("kitchen");
                                        ...
                                        Toast.makeText(kitchenUploadActivity.this, "Data save Successful", Toast.LENGTH_SHORT).show();
                                            dialog.dismiss();
