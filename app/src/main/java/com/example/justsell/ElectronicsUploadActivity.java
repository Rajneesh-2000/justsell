...
public class ElectronicsUploadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_electronics_upload);
        ...
        Task<Uri> uriTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        ...
                        database =FirebaseDatabase.getInstance();
                            mdatabaseref =database.getReference("electronics");
                        ...
                        Toast.makeText(ElectronicsUploadActivity.this, "Data save Successful", Toast.LENGTH_SHORT).show();
                            dialog.dismiss();
