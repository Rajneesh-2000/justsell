...
public class kitchenRecycleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kitchen_recycle);

        //mstorageRef= FirebaseStorage.getInstance().getReference("uploads");
        mdatabaseref= FirebaseDatabase.getInstance().getReference("uploads");
        recyclerView=findViewById(R.id.recyclercontactt);

        firebaseDatabase =FirebaseDatabase.getInstance();
        mdatabaseref =firebaseDatabase.getReference("kitchen");
